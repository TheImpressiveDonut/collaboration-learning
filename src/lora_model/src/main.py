...
def main(args):
    ...
    if args.model == 'lora':
        num_params = model.get_num_params(lora_params=True)
        num_trainable_params = model.get_num_params(lora_params=True, only_trainable=True)
        num_embedding_trainable_params = model.get_num_params(non_embedding=False, lora_params=True, only_trainable=True)
    elif args.model == 'base':
        num_params = model.get_num_params()
        num_trainable_params = model.get_num_params(only_trainable=True)
        num_embedding_trainable_params = model.get_num_params(non_embedding=False, only_trainable=True)
    ...
    if distributed_backend.is_master_process() and args.wandb:
        ...
        params_copy['num_params'] = num_params
        params_copy['num_trainable_params'] = num_trainable_params
        params_copy['num_embedding_trainable_params'] = num_embedding_trainable_params
