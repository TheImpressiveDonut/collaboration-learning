...
def get_args() -> Namespace:
    ...
    main_parser.add_argument('--dataset', type=str, required=True, help='name of the dataset to generate')
    ...
    # Model params
    main_parser.add_argument('--sequence_length', default=512, type=int)
