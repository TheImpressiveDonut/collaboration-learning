...
def fed_isic(args: Namespace) -> Tuple[
    ...
    raw_path = get_raw_path(args.dataset_name, create_dir=False)
    ...
    train_data, test_data, ref_data = train_test_ref_split(clients_data, args, mode='by-number')
